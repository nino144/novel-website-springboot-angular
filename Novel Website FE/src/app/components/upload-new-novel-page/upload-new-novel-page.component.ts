...
@Component({
  selector: 'app-upload-new-novel-page',
  standalone: true,
  imports: [MatFormFieldModule, 
            ...
            MatRadioModule,
            CommonModule],
  templateUrl: './upload-new-novel-page.component.html',
  styleUrl: './upload-new-novel-page.component.css'
})
export class UploadNewNovelPageComponent {
  novelName!: String;
  author!: String;
